...
include "configfinal.php";
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE `final` SET `student1points`='$student1points',`student2points`='$student2points',`student3points`='$student3points',`student4points`='$student4points' WHERE `question`='$question'"; 
...
if (isset($_GET['question'])) {
    ...
    $sql = "SELECT * FROM `final` WHERE `question`='$question'";
