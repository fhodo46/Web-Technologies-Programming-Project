...
include "configmidterm.php";
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `midterm`(`examcode`, `student1points`, `student2points`, `student3points`, `student4points`) VALUES ('$examcode','$student1points','$student2points','$student3points','$student4points')";
