...
<table class="table">
    ...
    <tbody> 
        ...
        ?>
                    ...
                    <td><a class="btn btn-info" href="updatefinal.php?question=<?php echo $row['question']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="deletefinal.php?question=<?php echo $row['question']; ?>">Delete</a></td>
